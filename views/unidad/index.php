        ...
        <div class="col-md-8 mx-auto">
          <div class="card">
            <div class="card-header">
              <h4>Mantenimiento de unidades</h4>

              <button type="button" class="btn btn-primary" id="add_unidad" data-toggle="modal" data-target="#modal_unidad">
                <i class="fa fa-plus"></i> Agregar</button>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped w-100" id="table_unidad">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Código</th>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Formulario unidades</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="form_unidad" method="post" novalidate>
            <input type="hidden" name="id" id="id">
            <input type="hidden" name="action" id="action" value="create">

            <div class="form-group">
              <label for="codigo">Código</label>
              <input type="text" id="codigo" name="codigo" class="form-control" pattern="[a-zA-Z0-9.-_ /]+" required>
              <div class="invalid-feedback">
                Oh no! Código is invalid.
              </div>
            </div>
...
<script src="<?= URL ?>public/js/unidad.js"></script>
