...
<div class="main-content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <button type="button" class="btn btn-primary" id="add_producto" data-toggle="modal" data-target="#modal_producto">
  ...
  <div class="modal fade" id="modal_producto" tabindex="-1" role="dialog" aria-hidden="true">
